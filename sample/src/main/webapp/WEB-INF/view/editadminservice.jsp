...
${idsads}
        <div id="section">
          <h1 class="text text-center">Edit Services</h1><br><hr><br>
          ${message}
          <div class="content1 w-50 ">
            <form:form method="post" action="/sample/service/updateService">
              ...
              <form:input type="hidden" value="${command.servicecode}" path="servicecode"/>
              <div class="d-flex justify-content-center py-2"><input type="submit" class="btn btn-success btn-lg" value="Update"></div>
