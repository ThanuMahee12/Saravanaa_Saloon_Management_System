...
<main class="vh-100 d-flex justify-content-center mt-4 pt-2">
    <div class="container w-50">
        <h2 class="text-center">Edit Appoiments</h2><br/><hr class="border-1"/>
        ${message}
        <form:form action="/sample/Appointment/EditAppointment" method="post" class="mt-5" >
            ...
            <input class="btn btn-info text-white fw-bolder" type="Edit" value="Edit"/>
        </form:form>
    </div>
</main>
